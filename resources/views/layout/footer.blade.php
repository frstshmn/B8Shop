                ...
                <div class="footer-content bg-black">
                    <div class="container d-flex flex-row justify-content-between">
                        <div class='d-flex flex-row align-items-center'>
                            ...
                            <p class="text-white p-14 font-weight-bold ml-3"> Copyright 2020 B8 Esports<br>All rights reserved.</p>
                        </div>
                        <div class='d-flex flex-row align-items-center'>
                            <p class="text-white text-right p-18 font-weight-bold">Contact Us<br>contact@b8esports.gg</p>
                        </div>
                    </div>
                </div>
